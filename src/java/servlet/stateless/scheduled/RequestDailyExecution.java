...
import servlet.stateless.validation.RequestValidationFilter;

/**
 *
 * @author fellippe.mendonca
 */
@WebServlet(name = "RequestDailyExecution", urlPatterns = {"/RequestDailyExecution"})
public class RequestDailyExecution extends HttpServlet {
    @EJB
