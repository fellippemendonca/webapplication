 ...
 */
@WebServlet(name = "ExecuteRequestValidation", urlPatterns = {"/ExecuteRequestValidation"})
public class ExecuteRequestValidation extends HttpServlet {
     @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            System.out.println("GET /ExecuteRequestValidation?requestId="+request.getParameter("requestId"));
            try {
                int requestId = Integer.parseInt(request.getParameter("requestId"));
                    out.write(sless.getRequestValidationExecuted(requestId));
