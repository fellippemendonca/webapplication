...
public class TemplateJpaController implements Serializable {
    ...
    public TemplateJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Template template) throws RollbackFailureException, Exception {
