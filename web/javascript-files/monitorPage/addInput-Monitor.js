...
function addValidationElement(divName, optionValue, fieldValue, optionName, ledColor) {
    if (ElementCounter3 == ElementLimit3) {
        ...
        ledIndicator.className = 'led-' + ledColor + '';
...
function addValidationScenario(divName, idValidationScenario, validationScenarioDescription, success, logId) {
    if (RequestValidationCounter == RequestValidationCounterLimit) {
        ...
        newdiv3.innerHTML = "View";
        newdiv3.setAttribute("onClick", "validationEdit(" + logId + "," + RequestValidationCounter + ")");
        /*-------------------------------------------*/
        cell1.appendChild(newdiv2);
        cell2.appendChild(newdiv3);
        divName.appendChild(cell1);
        divName.appendChild(cell2);
