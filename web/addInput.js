...
function addElement(divName, fieldValue) {
    if (ElementCounter == ElementLimit) {
        ...
        $("#" + divName + "Name" + ElementCounter + "").autocomplete(searchParameters(divName + "Name"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
        ElementCounter++;
    }
}
...
function addElement2(divName, fieldValue1, fieldValue2) {
    if (ElementCounter2 == ElementLimit2) {
        ...
        document.getElementById(divName).appendChild(newdiv);
        $("#" + divName + "Name" + ElementCounter2 + "").autocomplete(searchParameters(divName + "Name"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
        $("#" + divName + "Value" + ElementCounter2 + "").autocomplete(searchParameters(divName + "Value"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
        ElementCounter2++;
    }
}
...
$("#method").autocomplete(searchParameters("method"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
$("#environment").autocomplete(searchParameters("environment"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
$("#scheme").autocomplete(searchParameters("scheme"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
$("#host").autocomplete(searchParameters("host"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
$("#path").autocomplete(searchParameters("path"), "").focus(function() {$(this).autocomplete('search', $(this).val());});
});